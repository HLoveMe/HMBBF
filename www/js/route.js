angular.module('MBBF.routes', [])
    .config(function($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            ...
            .state("tab.homeLiveDetail", {
                url: "/home-live_detail",
                views: {
                    "tab-home": {
                        templateUrl: "templates/home/LiveDetail.html",
        ...
        .state("tab.homeSideSurveys", {
            ...
            //问卷详情
            .state("tab.homeSidesurveyDetail", {
                url: "paperDetail",
                views: {
                    "tab-home": {
                        templateUrl: "templates/sides/surveyDetail.html",
